...
public class NguoiHocDAO {
    ...
    public void insert(NguoiHoc model) {
        ...
        JdbcHelper.executeUpdate(sql, model.getMaNH(),model.getHoTen(), NguoiHocJFrame.txtNgaySinh.getText(), model.isGioiTinh(), model.getDienThoai(), model.getEmail(), model.getGhiChu(), Auth.USER.getMaNV());
    }
